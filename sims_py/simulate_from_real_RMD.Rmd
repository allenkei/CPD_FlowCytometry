...
## Read in data
datobj = readRDS("MGL1704-hourly-paper-new.RDS") ## change this to the file you have. We're only using the X object anyway.
colnames(datobj$X)
...
dimnames(Y_arr) <- NULL
saveRDS(Y_arr, file = paste("sim_dat_ult_",dff,"_",rep,".RDS", sep = ""))
saveRDS(Xa, file = paste("sim_x_ult_",dff,"_",rep,".RDS", sep = ""))
}
